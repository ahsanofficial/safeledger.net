    ...
    <div className="sm:pb-6">
      <div className={styles.back}>
        <div className="pt-6 pb-10 lg:mr-16 text-center">
          <h2 className="sm:text-4xl text-indigo-800	 font-extrabold text-3xl">
            Get to know Safe Legder better with our blog
          </h2>
        </div>
              ...
              <Card className="bg-slate-600 shadow-md rounded-xl">
                ...
                <CardContent className={styles.background}>
                  <Typography
                    variant="h6"
                    gutterBottom
                    className="text-indigo-800 font-bold pr-16"
                  >
                    Osome Partners With UK’s Entrepreneur Guru, Simon Squibb
                  </Typography>
                  <Typography variant="body2" className="text-indigo-800 pr-16">
                    Osome has partnered with Simon Squibb to help turn aspiring
                    entrepreneur’s dreams into a reality. The partnership aims
                    to..{" "}
                  </Typography>
