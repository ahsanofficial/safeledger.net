...
const SafeLedger = () => {
    ...
    return (
        <div className={`pt-16 text-center ${styles.bg}`} >
            <Typography variant='h4' className={`text-3xl sm:text-5xl lg:text-5xl  ${styles.tet}`} >
            ...
            <Typography className={`text-blue-700 text-3xl mt-8 ${styles.text}`} >Trust Safe Ledger for your business success.</Typography>
        </div>
    )
}
