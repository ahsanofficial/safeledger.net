...
const CompanySetup = () => {
    ...
    return (
        <div className={` ${styles.bg}`} >
            <div className={`mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-10 sm:py-0 lg:py-4 sm:px-6 lg:max-w-7xl lg:grid-cols-2 ${styles.center}`}>
                ...
                <div className=' sm:mt-16 lg:mt-16 lg:mr-16'>
