...
const ZohoFormService: React.FC<ZohoFormServiceProps> = ({ service }) => {
  ...
  @charset "UTF-8";
	...
	.zf-fmFooter .zf-submitColor{ font-size:25px; padding:4px 10px;}
  ...
  <div className="zf-templateWrapper">
    ...
    <div className="zf-subContWrap zf-topAlign"><ul className="ul">
        {/*-------Single Line Starts Here--------*/}
        <li className="zf-tempFrmWrapper zf-large">
			{/* <h3 className="zf-formHeading">Submit your Details to get an Instant <span className="highlightedHeadingText">All-inclusive</span> Quote to your email and a <span className="highlightedHeadingText">FREE</span> Expert consultation</h3> */}
	  ...
	  <em class="zf-important">*</em>
          ...
          <div className="zf-tempContDiv">
            <span> 
              <input type="text" className="fieldBgColor" name="SingleLine" check-type="c1" value={formData.SingleLine} onChange={handleChange} maxLength={255} field-type={1} placeholder="Full Name" required /></span> <p id="SingleLine_error" className="zf-errorMessage" style={{display: 'none'}}>Invalid value</p>
	  ...
	  <em class="zf-important">*</em>
          ...
          <div className="zf-tempContDiv">
            <span> <input field-type={9} type="email" maxLength={255} name="Email" check-type="c5" value={formData.Email} onChange={handleChange} placeholder="Enter Your Email" required /></span> <p id="Email_error" className="zf-errorMessage" style={{display: 'none'}}>Invalid value</p>
	  ...
	  <em class="zf-important">*</em>
          ...
          <div className="zf-tempContDiv zf-phonefld">
            <div className="zf-phwrapper">
              <span>
                <select className="zf-form-sBox" name="PhoneNumber_countrycodeval" check-type="c7" value={formData.PhoneNumber_countrycodeval} onChange={handleChange} required comp-name="PhoneNumber_countrycodeval"  max-length="10" phone-format="1" is-country-code-enabled="true" id="international_PhoneNumber_countrycodeval" val-type="code" >
              ...
              <label />
              <span> 
                <input type="text" comp-name="PhoneNumber" name="PhoneNumber_countrycode" maxLength={15} check-type="c7" value={formData.PhoneNumber_countrycode} onChange={handleChange} phone-format={1} iscountry-codeenabled="true" field-type={11} id="international_PhoneNumber_countrycode" val-type="number" phoneformat-type={1} placeholder="Mobile Number" required />
                <label /> </span>
              <div className="zf-clearBoth" /></div><p id="PhoneNumber_error" className="zf-errorMessage" style={{display: 'none'}}>Invalid value</p>
          </div><div className="zf-clearBoth" /></li>
        {/*-------Phone Ends Here--------*/} 
        {/*-------input Starts Here--------*/}
        <input type="text" name="SingleLine1" className="display-none" value={service} field-type={1} maxLength={255} placeholder="" />
        {/*-------input Ends Here--------*/}
      </ul></div>{/*-------template Container Starts Here--------*/}
    <ul className="ul"><li className="zf-fmFooter"><button className="zf-submitColor">Inquire Now</button></li></ul></div>
</div>
