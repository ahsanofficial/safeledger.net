                ...
                <Grid container spacing={3} className={`${styles.center} sm:mt-6`}>
                    <Grid item xs={12} sm={4}>
                        <div>
                            ...
                            <p className='text-slate-400 font-thin text-sm'>Info@safeledger.net</p>
                        </div>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                        <div className=''>
                            <Typography variant='h6' className='text-blue-700 font-bold'>Sales</Typography>
                            <p className='text-slate-400 font-thin text-sm'>Sales@safeledger.net</p>
                        </div>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                        <div className=''>
                            <Typography variant='h6' className='text-blue-700 font-bold'>Support</Typography>
                            <p className='text-slate-400 font-thin text-sm'>Support@safeledger.net</p>
                        </div>
                    </Grid>
